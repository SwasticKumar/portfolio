...
const FooterContainer = styled.div`
  ...
  background: linear-gradient(100.26deg,#93A5CF , #E4EfE9);
`;
...
function Footer() {
  return (
    <FooterContainer>
      <FooterWrapper>
        <Logo  style={{color:"black"}}> Swastic Kumar N</Logo>
        <Nav  >
        ...
        <SocialMediaIcons>
          ...
          <SocialMediaIcon  style={{color:" #0077b5"}}href={Bio.linkedin} target="display"><LinkedInIcon /></SocialMediaIcon>
          {/* <SocialMediaIcon  style={{color:"black"}}href={Bio.insta} target="display"><InstagramIcon /></SocialMediaIcon> */}
        </SocialMediaIcons>
        {/* <Copyright>
          &copy; 2024 KARTHICK. All rights reserved.
        </Copyright> */}
